...
This project is a framework for recommendation system that recommend Steam games based on user reviews (likes) using a CF approach.
...
| Average number of ratings per user | 4 (high sparsity)   |
